...
public class OperatorsTest extends ExpressionTest {
  ...
  public void GreaterThanOrEqualTo() throws Exception {
    ...
    writeEquals("FIELD_INTEGER>=80","80<=FIELD_INTEGER");
  ...
  public void LessThanOrEqualTo() throws Exception {
    ...
    writeEquals("FIELD_INTEGER<=5","5>=FIELD_INTEGER");
  ...
  public void CaseWhen() throws Exception {
    ...
    // Implicit ELSE NULL
    writeEquals("CASE WHEN FIELD_INTEGER=40 THEN 10 ELSE NULL END", "CASE WHEN 40=FIELD_INTEGER THEN 10 END");
