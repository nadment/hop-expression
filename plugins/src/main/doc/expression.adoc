...
|Integer|Boolean|✔|✔|TO_BOOLEAN
|Integer|Number|✔|✔|
|Integer|BigNumber|✔|✔|
|Integer|String|✔|✔|TO_CHAR
|Number|Boolean|✔|✔|TO_BOOLEAN
|Number|Integer|✔|✔|
|Number|BigNumber|✔|✔|
|Number|String|✔|✔|TO_CHAR
|BigNumber|Boolean|✔|✔|TO_BOOLEAN
|BigNumber|Integer|✔|✔|
|BigNumber|Number|✔|✔|
|BigNumber|String|✔|✔|TO_CHAR
|String|Boolean|✔|✔|TO_BOOLEAN
|String|Integer|✔|✔|TO_NUMBER
|String|Number|✔|✔|TO_NUMBER
|String|BigNumber|✔|✔|TO_NUMBER
|String|Date|❌|✔|TO_DATE
|String|Binary|❌|✔|TO_BINARY
|String|Json|❌|✔|TO_JSON
|Date|String|❌|✔|TO_CHAR
|Binary|String|❌|✔|TO_CHAR
|Json|String|✔|✔|
|===
