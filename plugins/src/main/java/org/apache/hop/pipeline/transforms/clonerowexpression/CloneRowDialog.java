...
public class CloneRowDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  public String open() {
    ...
    wcloneFlagField = new ExpressionText( pipelineMeta, wOutpuFields, SWT.SINGLE | SWT.LEFT | SWT.BORDER, false);
    ...
    wCloneNumField = new ExpressionText( pipelineMeta, wOutpuFields, SWT.SINGLE | SWT.LEFT | SWT.BORDER, false );
 				...
 				wnrClone.setRowMeta(rowMeta);
 				 ...
 				 new ErrorDialog(
 			          shell, BaseMessages.getString( PKG, "CloneRowDialog.FailedToGetFields.DialogTitle" ), BaseMessages
 				          .getString( PKG, "CloneRowDialog.FailedToGetFields.DialogMessage" ), e );
 			}
 		}
 	}).start();
