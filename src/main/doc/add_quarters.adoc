...
* If the resulting quarter has fewer days than the day component of date, then the result is the last day of the resulting quarter. Otherwise, the result has the same day component as a date.
