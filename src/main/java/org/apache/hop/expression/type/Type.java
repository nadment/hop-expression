...
public abstract class Type {
   ...
   *
   * <p>(-1) if precision is not applicable for this type.
   *
   * <p>Number of decimal digits for exact numeric types; number of decimal digits in mantissa for
   * approximate numeric types; number of decimal digits for fractional seconds of datetime types;
   * length in characters for String types; length in bytes for Binary types; 1 for BOOLEAN; -1 if
   * precision is not valid for this type
   */
  @Getter protected final int precision;

  /** The scale of this type, or (-1) if scale is not valid for this type. */
  @Getter protected final int scale;
