...
public class NegativeOperator extends PrefixUnaryOperator {
  ...
  public IExpression compile(IExpressionContext context, Call call) throws ExpressionException {
    ...
    if (Types.isInterval(type)) {
      return new Call(call.getPosition(), IntervalNegativeOperator.INSTANCE, call.getOperands());
    }
    ...
    NegativeOperator operator = NumberNegativeOperator.INSTANCE;
    if (Types.isInteger(type)) {
      operator = IntegerNegativeOperator.INSTANCE;
    }
  ...
  public static final class IntegerNegativeOperator extends NegativeOperator {
    public static final IntegerNegativeOperator INSTANCE = new IntegerNegativeOperator();

    private IntegerNegativeOperator() {
      super();
    }
  ...
  public static final class NumberNegativeOperator extends NegativeOperator {
    public static final NumberNegativeOperator INSTANCE = new NumberNegativeOperator();

    private NumberNegativeOperator() {
      super();
    }
  ...
  public static final class IntervalNegativeOperator extends NegativeOperator {
    public static final IntervalNegativeOperator INSTANCE = new IntervalNegativeOperator();

    private IntervalNegativeOperator() {
      super();
    }
