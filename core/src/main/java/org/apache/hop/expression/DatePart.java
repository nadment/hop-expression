...
public enum DatePart {
	...
	/**
	 * A number (1 for Sunday, 2 for Monday, …, 7 for Saturday) indicating the day
	 * of the week
	 */
	DAYOFWEEK("DOW"),

	/**
	 * A number (1 for Monday, …, 7 for Sunday) indicating the day of the week
	 ...
	 * The second (0-59).
	 */
	SECOND("SS"), MILLISECOND("MS"), MICROSECOND("MCS"), NANOSECOND("NS");
