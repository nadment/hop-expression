...
public final class NumberFormat extends BaseFormat {
	...
	public final static BigDecimal parse(String value, String format) throws ParseException {
...
//						output.insert(0, localGrouping);
				...
				throw new ExpressionException(BaseMessages.getString(PKG, "Expression.InvalidNumberFormat", source));
			}
		}
