...
public class ExpressionRegistry {
    ...
    for (Method method : methods) {
      try {
        ...
        for (String alias : annotation.alias()) {
          ...
          function = new Function(annotation.name(), alias, annotation.deterministic(), method,
              annotation.minArgs(), annotation.maxArgs(), annotation.category());
          operators.add(function);
  ...
  private final Set<Operator> operators =
      new TreeSet<>(Arrays.asList(Operator.ADD, Operator.SUBTRACT, Operator.MULTIPLY,
          Operator.DIVIDE, Operator.POWER, Operator.BITAND, Operator.BITOR, Operator.BITNOT,
          Operator.BITXOR, Operator.CAST, Operator.MODULUS, Operator.EQUAL, Operator.GREATER_THAN,
          Operator.GREATER_THAN_OR_EQUAL, Operator.ILIKE, Operator.LESS_THAN,
          Operator.LESS_THAN_OR_EQUAL, Operator.LESS_THAN_OR_GREATER_THAN, Operator.NOT_EQUAL,
          Operator.BOOLAND, Operator.BETWEEN, Operator.CASE, Operator.CONCAT, Operator.IN,
          Operator.IS, Operator.LIKE, Operator.BOOLNOT, Operator.BOOLOR, Operator.BOOLXOR));
