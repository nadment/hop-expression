...
public abstract class AbstractStepDialog<StepMetaType extends StepMetaInterface> extends BaseStepDialog
	...
	public AbstractStepDialog(Shell parent, Object stepMeta, TransMeta transMeta, String stepname) {
		...
		// setText(stepMeta.getClass().getAnnotation(org.apache.hop.core.annotations.Step.class).name());
	}
...
//    wOK.setLayoutData(new FormDataBuilder().bottom().right(wCancel, -ConstUI.SMALL_MARGIN).width(BUTTON_WIDTH).result());
	 ...
	 */
	/**
	 * Creates a new instance of {@link StepMetaType} and populates it with provided
